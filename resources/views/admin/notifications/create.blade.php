...
@section('title', 'Crear Nueva Notificación')

@section('content')
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Crear Nueva Notificación</h1>
        </div>
        ...
        <form action="{{ route('admin.notifications.store') }}" method="POST" class="space-y-6">
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="4" required class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md">{{ old('message') }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <input type="datetime-local" name="expiry_date" id="expiry_date" value="{{ old('expiry_date') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="sm:col-span-6">
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="is_public" name="is_public" type="checkbox" value="1" {{ old('is_public') ? 'checked' : '' }} class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                                    </div>
            ...
            <div class="flex justify-end">
                <a href="{{ route('admin.notifications.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mr-3">
                    Cancelar
                </a>
