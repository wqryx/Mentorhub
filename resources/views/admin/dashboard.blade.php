...
@if(session('error'))
    <div class="fixed top-4 right-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-gray-500">Sesiones Activas</p>
                                <p class="text-2xl font-bold text-gray-900">{{ \Illuminate\Support\Facades\Session::all()->count() }}</p>
                            </div>
                            <div class="text-purple-500">
                                <i class="fas fa-sign-in-alt fa-2x"></i>
                            </div>
