        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Editar Curso: {{ $course->title }}</h5>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('short_description') is-invalid @enderror" id="short_description" name="short_description" value="{{ old('short_description', $course->short_description) }}" required maxlength="255">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('what_will_learn') is-invalid @enderror" id="what_will_learn" name="what_will_learn" rows="4">{{ old('what_will_learn', $course->what_will_learn) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('requirements') is-invalid @enderror" id="requirements" name="requirements" rows="4">{{ old('requirements', $course->requirements) }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="mt-2" id="preview-container" style="display: none;">
                                        <img id="image-preview" src="#" class="img-fluid rounded" alt="Vista previa">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="is_featured" name="is_featured" value="1" {{ old('is_featured', $course->is_featured) ? 'checked' : '' }}>
