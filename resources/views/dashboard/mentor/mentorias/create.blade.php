...
@section('title', 'Crear Nueva Mentoría - MentorHub')

@section('content')
<div class="container-fluid">
    <!-- Encabezado -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Crear Nueva Mentoría</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('mentor.mentorias.store') }}" method="POST">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" 
                            ...
                            <option value="programming" {{ old('category') == 'programming' ? 'selected' : '' }}>Programación</option>
                            <option value="design" {{ old('category') == 'design' ? 'selected' : '' }}>Diseño</option>
                            <option value="business" {{ old('category') == 'business' ? 'selected' : '' }}>Negocios</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('duration') is-invalid @enderror" 
                               id="duration" name="duration" value="{{ old('duration', 60) }}" min="15" max="180" required>
                        @error('duration')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                                    ...
                                    <div class="card-header py-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   id="day_{{ $index }}" name="days[]" value="{{ $index + 1 }}">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="time" class="form-control form-control-sm" 
                                                       id="start_time_{{ $index }}" name="start_time[{{ $index + 1 }}]" 
                                                       value="09:00">
                                            </div>
                                            <div class="col-6">
                                                <label for="end_time_{{ $index }}" class="form-label small">Hasta</label>
                                                <input type="time" class="form-control form-control-sm" 
                                                       id="end_time_{{ $index }}" name="end_time[{{ $index + 1 }}]" 
                                                       value="18:00">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-1"></i> Guardar Mentoría
                    </button>
                </div>
            </form>
        </div>
